...
USE OPDdb;
INSERT INTO system_admin (username, password, first_name, last_name, email, phone_number) VALUES
('admin', '$2a$10$CwTycUXWue0Thq9StjUM0uG8BnUfbEgXpwGSWmzmOTa7NZl7gLMK2','Test', 'Admin', 'johndoe@example.com', '123-456-7890'); -- password : 123456

INSERT INTO patient (username, password, first_name, last_name, nic, address, email, gender, dob) VALUES
('Patient', '$2a$10$CwTycUXWue0Thq9StjUM0uG8BnUfbEgXpwGSWmzmOTa7NZl7gLMK2', 'Test', 'Patient', '1234567890', '123 Main St', 'janesmith@example.com', 'Female', '1990-01-01'); -- password : 123456

INSERT INTO healthcare_professional (username, password, first_name, last_name, email, phone_Number, role) VALUES
('prof1', '$2a$10$CwTycUXWue0Thq9StjUM0uG8BnUfbEgXpwGSWmzmOTa7NZl7gLMK2', 'Test', 'Doctor', 'chathura@example.com', '555-555-5555', 'Doctor'); -- password : 123456

INSERT INTO healthcare_professional (username, password, first_name, last_name, email, phone_Number, role) VALUES
('prof2', '$2a$10$CwTycUXWue0Thq9StjUM0uG8BnUfbEgXpwGSWmzmOTa7NZl7gLMK2', 'Test', 'Radiologist', 'chathura2@example.com', '555-555-5555', 'Radiologist'); -- password : 123456
